...
### Запуск в Linux
Начиная с версии OneScriptForms.dll 2.2.0.0 библиотека работает и под Linux. Тестирование производилось в Linux Mint 20.3 Una (с пакетом mono-complete, Версия 6.12.0.182-0xamarin1+ubuntu1804b1). Для успешной работы в Linux установите программный фреймвор mono. Установите так же пакеты (возможно другие версии, найденные в менеджере пакетов по запросу - VisualBasic):
