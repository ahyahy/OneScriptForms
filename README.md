...
Тесты проведены в операционных системах Windows 7 и Windows 10 на OneScript версий 1.3.0.1 и 1.6.0.213 и 1.7.0.214. Начиная с версии OneScriptForms.dll 2.2.0.0 библиотека работает и под Linux. Тестирование производилось в Linux Mint 20.3 Una (с пакетом mono-complete, Версия 6.12.0.182-0xamarin1+ubuntu1804b1).
