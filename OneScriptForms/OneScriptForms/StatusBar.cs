...
namespace osf
{
    ...
    public class ClStatusBar : AutoContext<ClStatusBar>
    {
        ...
        private ClStatusBarPanelCollection panels;
        ...
        public ClStatusBar()
        {
            ...
            panels = new ClStatusBarPanelCollection(Base_obj.Panels);
            backColor = new ClColor(Base_obj.BackColor);
            controls = new ClControlCollection(Base_obj.Controls);
        }
		
        public ClStatusBar(StatusBar p1)
        {
            StatusBar StatusBar1 = p1;
            StatusBar1.dll_obj = this;
            Base_obj = StatusBar1;
            bounds = new ClRectangle(Base_obj.Bounds);
            clientRectangle = new ClRectangle(Base_obj.ClientRectangle);
        ...
        [ContextProperty("ЗахватРазмера", "SizingGrip")]
        public bool SizingGrip
        {
            get { return Base_obj.SizingGrip; }
            set { Base_obj.SizingGrip = value; }
        }
        ...
        [ContextProperty("Панели", "Panels")]
        public ClStatusBarPanelCollection Panels
        {
            get { return panels; }
        }
        ...
        [ContextProperty("ПоказатьПанели", "ShowPanels")]
        public bool ShowPanels
        {
            get { return Base_obj.ShowPanels; }
            set { Base_obj.ShowPanels = value; }
        }
