...
namespace osf
{
    ...
    [ContextClass ("КлГоризонтальнаяПрокрутка", "ClHScrollBar")]
    public class ClHScrollBar : AutoContext<ClHScrollBar>
    {
        ...
        public ClHScrollBar()
        {
            ...
            HScrollBar1.dll_obj = this;
            Base_obj = HScrollBar1;
        ...
        public ClHScrollBar(HScrollBar p1)
        {
            HScrollBar HScrollBar1 = p1;
            HScrollBar1.dll_obj = this;
            Base_obj = HScrollBar1;
            bounds = new ClRectangle(Base_obj.Bounds);
            clientRectangle = new ClRectangle(Base_obj.ClientRectangle);
        ...
        {
            get { return Base_obj.LargeChange; }
            set { Base_obj.LargeChange = value; }
        }
        ...
        public IValue ValueChanged
        {
            get
            {
                if (Base_obj.ValueChanged.Contains("ScriptEngine.HostedScript.Library.DelegateAction"))
                {
                    return _ValueChanged;
                }
                else if (Base_obj.ValueChanged.Contains("osf.ClDictionaryEntry"))
                {
                    return _ValueChanged;
                }
                else
                {
                    return ValueFactory.Create((string)Base_obj.ValueChanged);
                }
            }
            set
            {
                if (value.GetType().ToString() == "ScriptEngine.HostedScript.Library.DelegateAction")
                {
                    ...
                    Base_obj.ValueChanged = "ScriptEngine.HostedScript.Library.DelegateAction" + "ValueChanged";
                }
                else if (value.GetType() == typeof(osf.ClDictionaryEntry))
                {
                    _ValueChanged = value;
                    Base_obj.ValueChanged = "osf.ClDictionaryEntry" + "ValueChanged";
                }
                else
                {
                    Base_obj.ValueChanged = value.AsString();
                }
            }
        }
        ...
        [ContextProperty("МалоеИзменение", "SmallChange")]
        public int SmallChange
        {
            get { return Base_obj.SmallChange; }
            set { Base_obj.SmallChange = value; }
        }
        ...
        public int Minimum
        {
            get { return Base_obj.Minimum; }
            set { Base_obj.Minimum = value; }
        }
        ...
        public IValue Scroll
        {
            get
            {
                if (Base_obj.Scroll.Contains("ScriptEngine.HostedScript.Library.DelegateAction"))
                {
                    return _Scroll;
                }
                else if (Base_obj.Scroll.Contains("osf.ClDictionaryEntry"))
                {
                    return _Scroll;
                }
                else
                {
                    return ValueFactory.Create((string)Base_obj.Scroll);
                }
            }
            set
            {
                if (value.GetType().ToString() == "ScriptEngine.HostedScript.Library.DelegateAction")
                {
                    ...
                    Base_obj.Scroll = "ScriptEngine.HostedScript.Library.DelegateAction" + "Scroll";
                }
                else if (value.GetType() == typeof(osf.ClDictionaryEntry))
                {
                    _Scroll = value;
                    Base_obj.Scroll = "osf.ClDictionaryEntry" + "Scroll";
                }
                else
                {
                    Base_obj.Scroll = value.AsString();
                }
            }
        }
