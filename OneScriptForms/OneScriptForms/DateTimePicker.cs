...
namespace osf
{
    ...
    public class ClDateTimePicker : AutoContext<ClDateTimePicker>
    {
        ...
        public ClDateTimePicker()
        {
            DateTimePicker DateTimePicker1 = new DateTimePicker();
            DateTimePicker1.dll_obj = this;
            Base_obj = DateTimePicker1;
        ...
        public ClDateTimePicker(DateTimePicker p1)
        {
            DateTimePicker DateTimePicker1 = p1;
            DateTimePicker1.dll_obj = this;
            Base_obj = DateTimePicker1;
            bounds = new ClRectangle(Base_obj.Bounds);
            clientRectangle = new ClRectangle(Base_obj.ClientRectangle);
        ...
        [ContextProperty("ВыравниваниеПриРаскрытии", "DropDownAlign")]
        public int DropDownAlign
        {
            get { return (int)Base_obj.DropDownAlign; }
            set { Base_obj.DropDownAlign = value; }
        }
        ...
        [ContextProperty("ПоказатьРегулятор", "ShowUpDown")]
        public bool ShowUpDown
        {
            get { return Base_obj.ShowUpDown; }
            set { Base_obj.ShowUpDown = value; }
        }

        [ContextProperty("ПоказатьФлажок", "ShowCheckBox")]
        public bool ShowCheckBox
        {
            get { return Base_obj.ShowCheckBox; }
            set { Base_obj.ShowCheckBox = value; }
        }
        ...
        [ContextProperty("Формат", "Format")]
        public int Format
        {
            get { return (int)Base_obj.Format; }
            set { Base_obj.Format = value; }
        }
