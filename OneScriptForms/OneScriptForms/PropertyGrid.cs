...
namespace osf
{
    ...
    public class ClPropertyGrid : AutoContext<ClPropertyGrid>
    {
        ...
        private IValue _PropertyValueChanged;
        private IValue _SelectedGridItemChanged;
        ...
        public IValue SelectedGridItemChanged
        {
            get
            {
                if (Base_obj.SelectedGridItemChanged.Contains("ScriptEngine.HostedScript.Library.DelegateAction"))
                {
                    return _SelectedGridItemChanged;
                }
                else if (Base_obj.SelectedGridItemChanged.Contains("osf.ClDictionaryEntry"))
                {
                    return _SelectedGridItemChanged;
                }
                else
                {
                    return ValueFactory.Create((string)Base_obj.SelectedGridItemChanged);
                }
            }
            set
            {
                ...
                {
                    _SelectedGridItemChanged = (ScriptEngine.HostedScript.Library.DelegateAction)value.AsObject();
                    Base_obj.SelectedGridItemChanged = "ScriptEngine.HostedScript.Library.DelegateAction" + "SelectedGridItemChanged";
                }
                else if (value.GetType() == typeof(osf.ClDictionaryEntry))
                {
                    _SelectedGridItemChanged = value;
                    Base_obj.SelectedGridItemChanged = "osf.ClDictionaryEntry" + "SelectedGridItemChanged";
                }
                else
                {
                    Base_obj.SelectedGridItemChanged = value.AsString();
                }
            }
        }
        ...
        public IValue PropertyValueChanged
        {
            get
            {
                if (Base_obj.PropertyValueChanged.Contains("ScriptEngine.HostedScript.Library.DelegateAction"))
                {
                    return _PropertyValueChanged;
                }
                else if (Base_obj.PropertyValueChanged.Contains("osf.ClDictionaryEntry"))
                {
                    return _PropertyValueChanged;
                }
                else
                {
                    return ValueFactory.Create((string)Base_obj.PropertyValueChanged);
                }
            }
            set
            {
                if (value.GetType().ToString() == "ScriptEngine.HostedScript.Library.DelegateAction")
                {
                    _PropertyValueChanged = (ScriptEngine.HostedScript.Library.DelegateAction)value.AsObject();
                    Base_obj.PropertyValueChanged = "ScriptEngine.HostedScript.Library.DelegateAction" + "PropertyValueChanged";
                }
                else if (value.GetType() == typeof(osf.ClDictionaryEntry))
                {
                    _PropertyValueChanged = value;
                    Base_obj.PropertyValueChanged = "osf.ClDictionaryEntry" + "PropertyValueChanged";
                }
                else
                {
                    Base_obj.PropertyValueChanged = value.AsString();
                }
            }
        }
