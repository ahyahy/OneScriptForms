...
namespace osf
{
    ...
    public class ClPictureBox : AutoContext<ClPictureBox>
    {
        ...
        public ClPictureBox()
        {
            ...
            PictureBox1.dll_obj = this;
            Base_obj = PictureBox1;
        ...
        public ClPictureBox(PictureBox p1)
        {
            PictureBox PictureBox1 = p1;
            PictureBox1.dll_obj = this;
            Base_obj = PictureBox1;
            bounds = new ClRectangle(Base_obj.Bounds);
            clientRectangle = new ClRectangle(Base_obj.ClientRectangle);
        ...
        [ContextProperty("РазмещениеФоновогоИзображения", "BackgroundImageLayout")]
        public int BackgroundImageLayout
        {
            get { return (int)Base_obj.BackgroundImageLayout; }
            set { Base_obj.BackgroundImageLayout = value; }
        }
