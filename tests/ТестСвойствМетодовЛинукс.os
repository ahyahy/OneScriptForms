...
Перем СписокОшибок, СписокОшибокКоличество, КаталогСправки, КаталогБиблиотеки, М_Свойств;
Перем ОшибочныеФайлы, КоличествоОшибочныхФайлов, УдачныеФайлы, КоличествоУдачныхФайлов;
...
Процедура ТестированиеСвойств();
	...
	Для А1 = 0 По Массив3.ВГраница() Цикл
		...
		Для А = 0 По Массив4.ВГраница() Цикл
			...
			// Если Не КлассАнгл = "TreeViewAdv" Тогда
			// 	Продолжить;
			// КонецЕсли;
			
			Если КлассАнгл = "NotifyIcon" 
				или КлассАнгл = "DataGridViewGrouper" 
				или КлассАнгл = "DataGridViewGrouperControl" 
				или КлассАнгл = "PropertyGrid" 
			Тогда
				Продолжить;
			КонецЕсли;
...
Процедура ТестированиеКодов()
	...
	Для А = 0 По ВыбранныеФайлы.ВГраница() Цикл
		...
		// Исключим объекты, не работающие в линукс.
		Если    (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.Clipboard.GetImage.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.Clipboard.SetImage.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.Control.BeginUpdate.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.Control.EndUpdate.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewButtonCell.FlatStyle.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewCell.Displayed.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewCheckBoxCell.FlatStyle.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewCheckBoxColumn.FlatStyle.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewComboBoxCell.MaxDropDownItems.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewComboBoxCell.Sorted.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouper.AlwaysGroupOnText.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouper.CollapseAll.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouper.DataGridView.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouper.DataGridViewGrouperStyle.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouper.ExpandAll.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouper.ForceAsText.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouper.GroupName.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouper.GroupSortOrder.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouper.GroupSortOrder.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouper.RemoveGroup.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouper.SelectRowsOnDoubleClick.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouper.SetGroup.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouper.ShowCount.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouper.ShowGroupName.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouper.ShowGroupName.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouper.StartCollapsed.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouperConstructor.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouperControl.Grouper.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouperControl.Left.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouperControl.Parent.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouperControl.PlaceBottom.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouperControl.PlaceLeft.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouperControl.PlaceRight.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouperControl.PlaceTop.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouperControl.Top.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouperControl.Width.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewGrouperControlConstructor.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DataGridViewHeaderCell.Frozen.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.DateTimePicker.Text.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.Form.Parent.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.Form.PinToDesktop.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.Form.UnpinFromDesktop.html")
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.GridItem.GridItemType.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.GridItem.GridItems.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.GridItem.Label.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.GridItem.Value.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.GridItemCollection.Count.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.GridItemCollection.Item.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.NotifyIcon.Click.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.NotifyIcon.ContextMenu.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.NotifyIcon.DoubleClick.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.NotifyIcon.Icon.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.NotifyIcon.MouseDown.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.NotifyIcon.MouseMove.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.NotifyIcon.MouseUp.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.NotifyIcon.Text.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.NotifyIcon.Visible.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.NotifyIconConstructor.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.OneScriptForms.DataGridViewGrouper.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.OneScriptForms.DataGridViewGrouperControl.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.OneScriptForms.DoMessageBox.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.OneScriptForms.HideConsole.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.OneScriptForms.MinimizedConsole.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.OneScriptForms.NotifyIcon.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.OneScriptForms.RestoreConsole.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.OneScriptForms.SendKeys.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.PropertyGrid.GridItems.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.PropertyGrid.GridItems2.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.PropertyGrid.PropertyValueChanged.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.PropertyGrid.SelectedGridItem.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.PropertyGrid.SelectedGridItemChanged.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.PropertyGridConstructor.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.OneScriptForms.PropertyGrid.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.PropertyGrid.SelectedObject.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.PropertyGrid.ToolbarVisible.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.PropertyGrid.PropertySort.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.OneScriptForms.FindWindowByCaption.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.OneScriptForms.MouseKeyPress.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.RichTextBox.Rtf.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.RichTextBox.SelectionIndent.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.Form.WindowState.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.PropertyValueChangedEventArgs.ChangedItem.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.PropertyValueChangedEventArgs.OldValue.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.SelectedGridItemChangedEventArgs.NewLabel.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.SelectedGridItemChangedEventArgs.NewValue.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.SelectedGridItemChangedEventArgs.OldLabel.html") 
			или (ВыбранныеФайлы[А].ПолноеИмя = КаталогСправки + "/OneScriptFormsru/OneScriptForms.SelectedGridItemChangedEventArgs.OldValue.html") 
		...
		Если М.Количество() > 0 Тогда
			Для А2 = 0 По М.Количество() - 1 Цикл
				...
				Если Не (СокрЛП(ТестовыйКод) = "") Тогда
					...
					Если СтрНайти(ТестовыйКод, "НажатьКнопкуМыши") > 0 Тогда
					Иначе
						Команда1("oscript", ИмяВременногоФайла, ПолеВвода1, ВыбранныеФайлы[А].Имя);
					КонецЕсли;
					Форма1.Фокус();
				КонецЕсли;
	...
	Сообщить("================================================================");
	Сообщить("УдачныеФайлы = " + Ф.Окружение().НоваяСтрока + УдачныеФайлы);
	Сообщить("КоличествоУдачныхФайлов = " + КоличествоУдачныхФайлов);
	Сообщить("");
	
	Сообщить("ОшибочныеФайлы = " + Ф.Окружение().НоваяСтрока + ОшибочныеФайлы);
	Сообщить("КоличествоОшибочныхФайлов = " + КоличествоОшибочныхФайлов);
...
Функция Команда1(ИмяФайла, Аргументы, Объект, ИмяФайлаСправки)
	...
	Попытка
		...
		КонецЕсли;
		УдачныеФайлы = УдачныеФайлы + ИмяФайлаСправки + Ф.Окружение().НоваяСтрока;
		КоличествоУдачныхФайлов = КоличествоУдачныхФайлов + 1;
	Исключение
		ОшибочныеФайлы = ОшибочныеФайлы + ИмяФайлаСправки + Ф.Окружение().НоваяСтрока;
		КоличествоОшибочныхФайлов = КоличествоОшибочныхФайлов + 1;
	КонецПопытки;
КонецФункции

Функция Команда2(ИмяФайла, Аргументы, Объект, КлассОшибки, ТекстТеста)
	ИнформацияЗапускаПроцесса1 = Ф.ИнформацияЗапускаПроцесса();
	ИнформацияЗапускаПроцесса1.ИмяФайла = ИмяФайла;
	ИнформацияЗапускаПроцесса1.Аргументы = Аргументы;
	ИнформацияЗапускаПроцесса1.СоздатьБезОкна = Истина;
		...
		Пока Стр1 <> Неопределено Цикл
			Если Стр1 <> "Тест завершен." Тогда
				...
				Если ПервыйСимвол = "{" Тогда
					...
					СписокОшибок.Добавить("////////// начало //////////");
					СписокОшибок.Добавить("" + ТекстТеста);
					СписокОшибок.Добавить("//////////конец //////////");
					...
					СписокОшибок.Добавить("//////////");
					СписокОшибок.Добавить("//////////");
					СписокОшибокКоличество = СписокОшибокКоличество + 1;
...
Функция Команда3(ИмяФайла, Аргументы, Объект, КлассОшибки, ТекстТеста)
	ИнформацияЗапускаПроцесса1 = Ф.ИнформацияЗапускаПроцесса();
	ИнформацияЗапускаПроцесса1.ИмяФайла = ИмяФайла;
	ИнформацияЗапускаПроцесса1.Аргументы = Аргументы;
	ИнформацияЗапускаПроцесса1.СоздатьБезОкна = Истина;
...
Процедура ТестированиеМетодов()
	...
	Для А1 = 0 По Массив3.ВГраница() Цикл
		...
		Для А = 0 По Массив4.ВГраница() Цикл
			...
			// // Так можно избирательно проверить класс
			// Если Не КлассАнгл = "TreeViewAdv" Тогда
			// 	Продолжить;
			// КонецЕсли;
			
			// Эти классы целиком не поддерживаются в линукс
			Если КлассАнгл = "NotifyIcon" 
				или КлассАнгл = "DataGridViewGrouper" 
				или КлассАнгл = "DataGridViewGrouperControl" 
				или КлассАнгл = "PropertyGrid" 
...
ОшибочныеФайлы = "";
КоличествоОшибочныхФайлов = 0;

УдачныеФайлы = "";
КоличествоУдачныхФайлов = 0;
...
ПолеВвода1.ДобавитьТекст("Ошибок = " + СписокОшибокКоличество + Символы.ПС);
